...
import 'package:buyer_common_code/components/widgets/introduction_widget/ui/intro_button.dart';
import 'package:buyer_common_code/components/widgets/introduction_widget/ui/intro_page.dart';
import 'package:flutter_keyboard_visibility/flutter_keyboard_visibility.dart';

import '../../dot_indicator/dots_decorator.dart';
import '../../dot_indicator/dots_indicator.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.showSkipButton) {
      leftBtn = Visibility(
        ...
        maintainSize: true,
        child: widget.overrideSkip ?? IntroButton(child: widget.skip!, style: widget.baseBtnStyle?.merge(widget.skipStyle) ?? widget.skipStyle, semanticLabel: widget.skipSemantic, onPressed: _onSkip),
      );
