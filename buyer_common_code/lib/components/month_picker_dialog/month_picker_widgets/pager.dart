...
class PickerPager extends StatelessWidget {
  const PickerPager({super.key, required this.controller, required this.selector, required this.theme});
    ...
    return SizedBox(
      ...
      child: Theme(
        ...
        child: AnimatedSwitcher(
          ...
          reverseDuration: Duration(milliseconds: controller.animationMilliseconds),
