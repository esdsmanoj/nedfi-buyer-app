...
Map<String, String> headerParams = {"client-type": "buyer"};
...
ValueNotifier<List<NewProductsData>> newProduct = ValueNotifier([]);
ValueNotifier<List<NewProductsData>> trendingProduct = ValueNotifier([]);
...
class ApiURL {
  ...
  static const isRegistered = "buyer/is_user_regsitered";
  ...
  static const getRegister = "buyer/register_otp";
  static const getMasterListing = "trade/get_listing";
  static const getTradeProducts = "buyer/trade_product";
  static const addInterest = "buyer/add_interest_onproduct";
  static const addBidding = "buyer/trade_product_bidding";
  static const getManageProducts = "buyer/manage_product";
  ...
  static const buyerAction = "buyer/buyer_action";
  ...
  // static const tradeProduct = "buyer/trade_product";
  ...
  static const myStats = "buyer/my_stats";
  static const newProduct = "buyer/new_product";
  static const trendingProduct = "buyer/trending_product";
  static const addDemandProduct = "/trade/add_demand_product";
