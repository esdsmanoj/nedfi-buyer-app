...
import '../model/User.dart' as data;
...
class HeaderSingleton {
  ...
  String? image;
  String? privacy_policy = "https://www.famrut.com/privacy-policy.html";
  ...
  ValueNotifier<String> xAPIKey = ValueNotifier("CODEX@123"), domain = ValueNotifier(""), appName = ValueNotifier(""), client_type = ValueNotifier("buyer");
