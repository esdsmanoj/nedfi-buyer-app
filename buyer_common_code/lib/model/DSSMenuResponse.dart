class DSSMenuResponse {
  ...
  late final List<DSSMenuData> data;
  late final ConfigUrl configUrl;
  late final String message;

  DSSMenuResponse.fromJson(Map<String, dynamic> json){
    status = json['status'];
    data = List.from(json['data']).map((e)=>DSSMenuData.fromJson(e)).toList();
...
class DSSMenuData {
  ...
  DSSMenuData.fromJson(Map<String, dynamic> json){
    name = json['name']??"";
    icon = json['icon']??"";
