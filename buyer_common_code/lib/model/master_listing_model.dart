...
class Data {
  ...
  List<BuyerStatus>? buyerStatus;
  List<BuyerStatus>? buyerTradeStatus;
  List<UserType>? userType;
  List<UserType>? businessType;
  List<UserType>? businessScheme;
  List<UserType>? fpcBusinessScheme;
  Data(
      {this.productCategory, this.season, this.productUnit, this.productPayment, this.tradeStatusList, this.buyerStatus, this.buyerTradeStatus, this.userType, this.businessType, this.businessScheme,this.fpcBusinessScheme});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['buyer_status'] != null) {
      buyerStatus = <BuyerStatus>[];
      json['buyer_status'].forEach((v) {
        buyerStatus!.add(new BuyerStatus.fromJson(v));
      });
    }
    if (json['buyer_trade_status_filter'] != null) {
      buyerTradeStatus = <BuyerStatus>[];
      json['buyer_trade_status_filter'].forEach((v) {
        buyerTradeStatus!.add(new BuyerStatus.fromJson(v));
      });
    }
    ...
    if (json['fpc_business_scheme'] != null) {
      fpcBusinessScheme = <UserType>[];
      json['fpc_business_scheme'].forEach((v) {
        fpcBusinessScheme!.add(UserType.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (buyerStatus != null) {
      data['buyer_status'] = buyerStatus!.map((v) => v.toJson()).toList();
    }
    if (buyerTradeStatus != null) {
      data['buyer_trade_status_filter'] = buyerTradeStatus!.map((v) => v.toJson()).toList();
    }
    if (userType != null) {
    ...
    if (fpcBusinessScheme != null) {
      data['fpc_business_scheme'] = fpcBusinessScheme!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class BuyerStatus {
  ...
  BuyerStatus({this.id, this.title, this.mapKey, this.txtColor, this.statusClass});

  BuyerStatus.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    mapKey = json['map_key'];
