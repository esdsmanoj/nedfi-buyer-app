...
class TradeProductData {
  ...
  String? tradeProductBiddingCount;
  String? buyerInterestCount;
  ...
  String? bidderId;
  String? soldBidDate;
  String? prodDetailsTitle;
  String? highestBid;
  String? tradeProductBiddingId;
  String? interestBuyerId;
  String? soldToBuyerId;
  String? buyerActionTitle;
  String? manageProductStatus;
  String? manageProductStatusId;
  String? bidPlaceDate;
  RatingDetails? ratingDetails;
  bool? revokeExpire;
  String? bidStatus;
  String? bidPrice;
  String? bid_rejected_date;
  String? bid_revoked_date;
  ...
  TradeProductData(
      ...
      this.bidderId,
      this.soldBidDate,
      this.prodDetailsTitle,
      this.highestBid,
      this.tradeProductBiddingId,
      this.interestBuyerId,
      this.buyerActionTitle,
      this.manageProductStatus,
      this.manageProductStatusId,
      this.soldToBuyerId,
      this.revokeExpire,
      this.bidPlaceDate,
      this.bidStatus,
      this.bid_rejected_date,
      this.bid_revoked_date,
      this.bidPrice});
  ...
  TradeProductData.fromJson(Map<String, dynamic> json) {
    ...
    tradeProductBiddingCount = json['trade_product_bidding_count'].toString();
    buyerInterestCount = json['buyer_intrest_count'].toString();
    prodDetailsTitle = json['product_details_title'] ?? "";
    soldBidDate = json['sold_bid_date'];
    highestBid = json['highestBid'];
    interestBuyerId = json['interestBuyerId'];
    tradeProductBiddingId = json['tradeProductBiddingId'];
    soldToBuyerId = json['sold_to_buyer_id'];
    buyerActionTitle = json['buyer_action_title'];
    manageProductStatus = json['manage_product_status'];
    revokeExpire = json['revoke_expire'];
    bidPlaceDate = json['bid_place_date'];
    bidStatus = json['bidStatus'];
    bid_rejected_date = json['bid_rejected_date'];
    bid_revoked_date = json['bid_revoked_date'];
    bidPrice = json['bid_price'];
    manageProductStatusId = json['manage_product_status_id'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['product_details_title'] = prodDetailsTitle;
    data['highestBid'] = highestBid;
    data['tradeProductBiddingId'] = tradeProductBiddingId;
    data['interestBuyerId'] = interestBuyerId;
    data['buyer_action_title'] = buyerActionTitle;
    data['manage_product_status_id'] = manageProductStatusId;
    data['manage_product_status'] = manageProductStatus;
    data['sold_to_buyer_id'] = soldToBuyerId;
    data['revoke_expire'] = revokeExpire;
    data['bid_place_date'] = bidPlaceDate;
    data['bidStatus'] = bidStatus;
    data['bid_rejected_date'] = bid_rejected_date;
    data['bid_revoked_date'] = bid_revoked_date;
...
class OtherDetails {
  ...
  OtherDetails(
      {this.seasonFrom,
        ...
        this.yieldTo,
        this.yieldToUnit,
        this.yieldFromUnitText,
        this.yieldToUnitText});
  ...
  Map<String, dynamic> toJson() {
    ...
    data['season_from'] = this.seasonFrom;
    data['season_to'] = this.seasonTo;
    data['availability_from'] = this.availabilityFrom;
    data['availability_to'] = this.availabilityTo;
    data['yield_from'] = this.yieldFrom;
    data['yield_from_unit'] = this.yieldFromUnit;
    data['yield_to'] = this.yieldTo;
    data['yield_to_unit'] = this.yieldToUnit;
    data['yield_from_unit_text'] = this.yieldFromUnitText;
    data['yield_to_unit_text'] = this.yieldToUnitText;
    return data;
  }
}
