...
class AdvisoryCropResponse {
  AdvisoryCropResponse({
  ...
  AdvisoryCropResponse.fromJson(Map<String, dynamic> json){
    status = json['status'];
    nwKey = HashMap.from(json['nw_key']);
    data = List.from(json['data']).map((e)=>AdvisoryCropData.fromJson(e)).toList();
