...
import 'package:buyer_common_code/pages/helpdesk/create_ticket.dart';
import 'package:buyer_common_code/pages/helpdesk/helpdesk_ticket_details.dart';
...
class _HelpDeskScreenState extends State<HelpDeskScreen> {
            ...
            child: Scaffold(
              ...
              body: Padding(
                  ...
                  child: ValueListenableBuilder(
                    ...
                    builder: (newCtx, List<Tickets>? snapshot, child) {
                              ...
                              SizedBox(
                                child: ValueListenableBuilder(
                                    ...
                                    builder: (ticketCtx, ticketSnapshot, child) {
                                      return ticketSnapshot != null && (ticketSnapshot.isNotEmpty)
                                          ? GridView.builder(
                                          ...
                                          itemBuilder: (ticketContext, ticketIndex) {
                                            ...
                                            return InkWell(
                                              ...
                                              child: Container(
                                                  ...
                                                  decoration:
                                                      BoxDecoration(color: const Color(0xFFFFFFFF), border: Border.all(color: const Color(0xFFCFCFCF)), borderRadius: BorderRadius.circular(8))),
                                            );
                                          }),
                                    )
                                  : Container(
  ...
  Future checkUserLogin() async {
    try {
      String userType = "2"; //await SharePrefsHelper.getInstance(context)?.getStringValue("userType") ?? "0";
      final params = {
