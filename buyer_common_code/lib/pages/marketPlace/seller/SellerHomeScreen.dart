...
class _SellerHomeScreenState extends State<SellerHomeScreen> {
  ...
  productListItems(String page) {
    ...
    return products.isNotEmpty?RefreshIndicator(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (context, index) => productItem(products[index], index))):Center(child: Text("No product available".tr),);
  }
  ...
  imageDialog(String? images) {
    return Dialog(
      ...
      child: PhotoView(imageProvider: AssetImage(images ?? "")),
    );
  }
