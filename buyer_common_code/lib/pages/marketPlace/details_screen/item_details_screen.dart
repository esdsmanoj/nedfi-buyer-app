          ...
          child: SingleChildScrollView(
            ...
            child: Html(
              ...
              style: {
                ...
                // "tr": Style(padding: const EdgeInsets.all(2), border: Border.all(color: Colors.black),fontFamily: 'Graphik', fontWeight: FontWeight.w400, ),
                // "th": Style(padding: const EdgeInsets.all(2), border: Border.all(color: Colors.black),fontFamily: 'Graphik', fontWeight: FontWeight.w400, ),
                // "td": Style(padding: const EdgeInsets.all(2), border: Border.all(color: Colors.black),fontFamily: 'Graphik', fontWeight: FontWeight.w400, ),
              },
              /*customRender: {
                "table": (context, child) {
