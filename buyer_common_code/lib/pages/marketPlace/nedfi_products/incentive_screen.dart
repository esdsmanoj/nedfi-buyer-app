...
import '../../../model/trade_incentive.dart';
                ...
                productData.value![0].statusTitle!.toLowerCase() == "sold" || productData.value![0].statusTitle!.toLowerCase() == "completed"
                    ? Row(
                        ...
                        children: [
                          ...
                          WidgetUtils.appTextWidget(context: context, title: widget.bidderDate ?? "", color: const Color(0xff3F3F3F), fontWeight: FontWeight.w400, fontSize: 14, family: 'Graphik'),
                        ],
                      )
                    : Container(),
                // productData.value![0].statusTitle!.toLowerCase() == "sold" || productData.value![0].statusTitle!.toLowerCase() == "completed" ? const SizedBox(height: 1) : Container(),
  ...
  Future submitIncentiveReport() async {
    try {
      ...
      if (result["success"] == 1) {
        ...
        setState(() {});
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (buildRoute) => const NedfiProductListScreen(isFrom: "incentive")));
      }
    } catch (e) {
      rethrow;
    }
