                    ...
                    return GestureDetector(
                      onTap: () {
                        Map<String, dynamic> params = {
                          'id': services![index].catId,
                          'name': HeaderSingleton().local == 'en' ?services![index].name! : services![index].nameMr!
                        };
                        HelperUtils().navigateToScreens(call: () => setState(() {}), context: context, mapKey: services![index].mapKey??"", params: params);
                      },
                      child: Column(
