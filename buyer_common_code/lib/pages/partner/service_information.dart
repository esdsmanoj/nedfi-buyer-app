...
import 'package:buyer_common_code/model/common_model.dart';
import 'package:buyer_common_code/pages/partner/ServiceDetailsScreen.dart';
import 'package:buyer_common_code/services/api_service.dart';
...
import '../../components/localization/app_translations.dart';
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Container(height: 76, width: 76, decoration: BoxDecoration(borderRadius: BorderRadius.circular(4)),
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: WidgetUtils.appTextWidget(
                                                    context: context,
                                                    softWrap: false,
                                                    title: serviceList[index].productServicesName ?? "",
                                                    textAlign: TextAlign.left,
                                                    overflow: TextOverflow.ellipsis,
                                                    color: const Color(0xFF000000),
                                                    fontWeight: FontWeight.w500,
                                              ...
                                              SizedBox(
                                                ...
                                                height:100,
                                                child: Html(
                                                  data: unescape.convert(serviceList[index].brief ?? ""),
                                                  style: {
                                                    'h1': Style(fontFamily: 'Graphik', fontWeight: FontWeight.w400, fontSize:  FontSize(14), letterSpacing: 0.0),
                                                    'h2': Style(fontFamily: 'Graphik', fontWeight: FontWeight.w400, fontSize:  FontSize(14), letterSpacing: 0.0),
                                                    'h3': Style(fontFamily: 'Graphik', fontWeight: FontWeight.w400, fontSize:  FontSize(14), letterSpacing: 0.0),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        WidgetUtils.appTextWidget(context: context, title: 'Enquire'.tr, color: Color(int.parse(themeColor.value.barColor!.color!)), fontWeight: FontWeight.w500, fontSize: 14)
                                                      ],
                                                    ),
                                                  ),
                                                ),
                ...
                return StatefulBuilder(builder: (builderContext, StateSetter setState) {
                  return AlertDialog(
                      ...
                      title: WidgetUtils.appTextWidget(
                          context: context, title: (partnerDetails.firstName ?? "") + " " + (partnerDetails.lastName ?? "") , textAlign: TextAlign.start, fontWeight: FontWeight.w700, family: 'Graphik', fontSize: 16),
                      content: SizedBox(
