...
import 'package:buyer_common_code/model/pan_authentication_model.dart';
import 'package:get/get.dart';

import '../../model/authenticate_aadhar_Card.dart';
import '../../model/bank_verification.dart';
  ...
  Future verifyPAN(TextEditingController controller, bool isBusinessPan) async {
    ...
    try {
      if (controller.text.isEmpty) {
        ...
        final response = await APIService.postAPIMethod(url: ApiURL.verifyPAN, params: {'user_id': userId.isEmpty ? HeaderSingleton().paramsMaps!.userId! : userId, 'pan_no': controller.text});
