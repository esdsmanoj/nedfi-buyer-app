      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Padding(
          ...
          child: WidgetUtils.buttonWidget(
              ...
              callback: () async {
                if (HeaderSingleton().ekycStatus.value!.panVerifySataus == "1" && HeaderSingleton().ekycStatus.value!.aadhaarVerifySataus == "1") {
                  if (HeaderSingleton().ekycStatus.value!.businessPanVerifyStatus == "1" && HeaderSingleton().ekycStatus.value!.appUserType == "0") {
                    checkDetails();
                  } else {
                    checkDetails();
                  }
                } else if (HeaderSingleton().ekycStatus.value!.ekycPanVerify != "1") {
