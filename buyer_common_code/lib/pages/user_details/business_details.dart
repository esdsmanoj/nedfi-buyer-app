  ...
  Future getUserProfile() async {
    try {
      ...
      if (res.success == 1 && res.data != null) {
        ...
        //  businessScheme = res.data![0].businessScheme ?? masterListing!.data!.businessScheme![0].title!;
              ...
              child: Column(
                ...
                children: [
                  ...
                  WidgetUtils.buttonWidget(
                      context: context,
                      radius: 8,
                      title: widget.isActive ? "Update Profile".tr : 'Next'.tr,
                      size: 18,
                      family: 'Graphik',
