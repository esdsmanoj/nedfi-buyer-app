...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  int _groupValue = -1;
  String? stateID, cityId, mobileNumber;
  ...
  /// Get all localised stored data from locale storage.
  ...
  /// Getting user profile details from the SERVER.
        ...
        child: CustomProgressHandler(
            ...
            child: Scaffold(
                ...
                appBar: widget.isActive
                    ...
                    : null,
                body: SafeArea(child: SingleChildScrollView(child: registrationWidget())))));
  }

  /// Registration screen UI design widget.
  ...
  /// Checking validations on button pressed.
  Future otherValidation() async {
  ...
  /// Building personal information UI design.
  ...
  /// registering the user information that entered in the field.
  ...
  /// Showing gender dialog as user clicked.
  ...
  /// Showing state and city list as per the user opens the dialog.
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), border: Border.all(color: Color(int.parse(themeColor.value.barColor!.color!)))),
                              child: TextField(
                                controller: controllerOne,
                                decoration: InputDecoration(
                                    suffixIcon: InkWell(
                                        child: SizedBox(height: 20, width: 20, child: Icon(Icons.close, color: Color(int.parse(themeColor.value.barColor!.color!)))),
                                        onTap: () {
                                          controllerOne.clear();
