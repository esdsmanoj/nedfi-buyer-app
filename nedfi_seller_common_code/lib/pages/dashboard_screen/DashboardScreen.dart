...
import 'package:nedfi_seller_common_code/model/HomeCatagoryResponse.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  /// Building the Media list UI widget.
  ...
  /// Building the recommended products UI widget.
  ...
  /// Building the blog type UI widget.
  ...
  /// Building the advertise UI widget.
        ...
        children: [
          Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                InkWell(
                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (ctx) => const NedfiAdvertisement())),
                  child: Row(
                    children: [
                      WidgetUtils.appTextWidget(
                          context: context,
  ...
  /// Building the blog items UI widget.
  ...
  /// Building the commodity details UI widget.
  Widget getCommodity() {
    return Column(
      children: [
        Padding(
            ...
            child: SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    if (tempCommodityList[index].isLocationPermissionItem) {
                      return InkWell(
                        onTap :() async =>await  HelperUtils().handlePermissionRequest(context).then((value) {
                          fetchCommodityNew("");
                        },),
                        child: Container(
                          width: 162,
  ...
  /// Building the whether details UI widget.
  Widget buildWeather() {
    return Column(
      children: [
  ...
  /// Building the trending product details UI widget.
  Widget buildTrendingProducts() {
    return ValueListenableBuilder(
        valueListenable: treandingproduct,
        builder: (BuildContext context, List<NewProductsData> value, Widget? child) {
          return Wrap(
            children: [
              ...
              Padding(
                ...
                child: Container(
                    ...
                    child: ValueListenableBuilder(
                        ...
                        builder: (BuildContext context, statsValue, Widget? child) {
              ...
              SizedBox(height: MediaQuery.of(context).size.height * 0.01),
              value.isEmpty
                  ? SizedBox(height: MediaQuery.of(context).size.height * 0.22, width: MediaQuery.of(context).size.width, child: Center(child: Text("No data found".tr)))
                  : Container(
  ...
  Widget buildStatWidget() {
    return ValueListenableBuilder<List<StatisticsReportData>>(
      valueListenable: productReport,
      builder: (BuildContext context, List<StatisticsReportData> reportData, Widget? child) {
        final int crossAxisCount = 3;
        final int rowCount = (reportData.length / crossAxisCount).ceil();
        final double rowHeight = 145;
          ...
          child: Column(
            children: [
              Container(
                ...
                child: ValueListenableBuilder<List<StatisticsFilterData>>(
                        ...
                        onChanged: (value) async {
                          ...
                          for (final details in statsValue) {
                            if (details.title == statType) {
                              await HelperUtils().getProductReport(() => setState(() {}),
                                  day: details.title?.toLowerCase() == "day" ? details.value! : "",
                                  month: details.title?.toLowerCase() == "month" ? details.value! : "",
                                  year: details.title?.toLowerCase() == "year" ? details.value! : "");
                              break;
                            }
                          }
                          isLoading.value = false;
              ...
              reportData.isNotEmpty
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final title = item.statusTitle?.toLowerCase() ?? "";

                    String imagePath;
                    switch (title) {
                      case "expired":
                        imagePath = "assets/images/stat_expired.png";
                        break;
                      case "completed":
                        imagePath = "assets/images/stat_completed.png";
                        break;
                      case "published":
                      case "live":
                        imagePath = "assets/images/stat_publish.png";
                        break;
                      case "approved":
                        imagePath = "assets/images/stat_approve.png";
                        break;
                      case "pending":
                      case "draft":
                        imagePath = "assets/images/stat_pending.png";
                        break;
                      case "sold":
                        imagePath = "assets/images/stat_sold.png";
                        break;
                      default:
                        imagePath = "assets/images/stat_sold.png";
                    }
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => AddProductMainScreen(type: "NEW")),
                            ).then((value) {
                              HelperUtils().getProductReport(() {
                                setState(() {
  ...
  /// Building the Statistics UI card.
  Widget buildStatsCard(String status, String title, String imageName, String count) {
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => NedfiProductListScreen(isFrom: 'home', status: status)));
      },
      child: SizedBox(
        height: 120,
        child: Stack(
  ...
  /// Fetching the latest commodity details as per the market.
      ...
      if (connectionServerMsg != "key_check_internet") {
        ...
        if (data['success'] != 1) {
          ...
          if (data['data'].isEmpty) {
            ...
            print("isLocation.value :"+isLocation.value.toString());
            if (isLocation.value) {
              tempCommodityList.add(NewCommoditydata(isLocationPermissionItem: true));  // Add a special item
              print("isLocation.value :"+tempCommodityList.length.toString());
            }
          }
          if (isFrom) {
            if (mounted) setState(() {});
