...
class _CreateTicketScreenState extends State<CreateTicketScreen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      WidgetUtils.appTextWidget(context: context, title: 'Upload Attachments'.tr, fontWeight: FontWeight.w500, family: 'Graphik', fontSize: 16),
                      const SizedBox(height: 08),
                      Container(
                          ...
                          child: imagePath == null || (imagePath?.isEmpty ?? false)
                              ? Column(
                                  children: [
                                    InkWell(
                                      onTap: () async {
                                        List<File>? filePath = await HelperUtils().getFromGallery(
                                            context,
                                            0,
                                            isMultiImagePick: true,
                                            isDocumentPick: true
                                        );
                                        ...
                                        if (filePath != null && filePath.isNotEmpty) {
                                          ...
                                          // Initialize isSelected list if needed
                                          isSelected = List<bool>.filled(filePath.length, false);
  ...
  Future createNewTicket() async {
    ...
    try {
      ...
      request.fields["department_id"] = "1";
