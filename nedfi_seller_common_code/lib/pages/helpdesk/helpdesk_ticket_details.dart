...
import '../../components/markdown/markdown_raw.dart';
import '../../components/markdown/markdown_style.dart';
...
class _HelpDeskTicketDetailsState extends State<HelpDeskTicketDetails> {
                    ...
                    return value != null
                        ? Column(
                            ...
                            children: [
                              ...
                              // ),
                              // const SizedBox(height: 12),
                              WidgetUtils.appTextWidget(context: context, title: 'Attachments'.tr, fontWeight: FontWeight.w500, family: 'Graphik', fontSize: 16),
                              const SizedBox(height: 12),
  ...
  Future getAllAttachments(String ticketId, String? messageId) async {
    try {
      final params = {'ticket_id': ticketId, 'msg_id': messageId ?? '', 'user_lang': lang};
