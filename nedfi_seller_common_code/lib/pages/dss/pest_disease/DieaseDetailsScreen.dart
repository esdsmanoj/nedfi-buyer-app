      ...
      return SafeArea(
        child: Scaffold( backgroundColor: Colors.white,
          appBar: AppBar(
            ...
            title: WidgetUtils.appTextWidget(context: context, title: widget.diseaseDetailsScreen?.diseaseName??"", color: Colors.white, fontSize: 18, fontWeight: FontWeight.w500, family: 'Graphik'),
