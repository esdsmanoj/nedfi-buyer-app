    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 1),
          productData.value![0].prodCatId == "2" ? Container() : const Divider(),
          // const SizedBox(height: 3),
          ...
          (productData.value![0].prodCatId != "2")? productData.value![0].statusTitle!.toLowerCase() != "pending" ? const Divider() : Container() : Container(),
          ...
          Row(
            ...
            children: [
              ...
              WidgetUtils.appTextWidget(
                  context: context,
                  title: (productData.value![0].otherDetails?.availableFrom ?? "") + "-" +
                      (productData.value![0].otherDetails?.availableTo ?? ""),
                  color: const Color(0xff3F3F3F),
                  fontWeight: FontWeight.w400,
                  fontSize: 14,
                  family: 'Graphik'),
                                              ...
                                              children: [
                                                Column(
                                                  children: [
                                                    ...
                                                    WidgetUtils.appTextWidget(
                                                        context: context, title: productData.value![0].ratingDetails?.happyCount.toString() ?? "0", color: const Color(0xFF000000), fontWeight: FontWeight.w500, fontSize: 12, family: 'Graphik'),
                                                  ],
                                                ),
                                                ...
                                                Column(
                                                  children: [
                                                    ...
                                                    WidgetUtils.appTextWidget(
                                                        context: context, title: productData.value![0].ratingDetails?.averageCount.toString() ?? "0", color: const Color(0xFF000000), fontWeight: FontWeight.w500, fontSize: 12, family: 'Graphik'),
                                                  ],
                                                ),
                                                const SizedBox(width: 10),
                                                Column(
                                                  children: [
                                                    ...
                                                    WidgetUtils.appTextWidget(
                                                        context: context, title: productData.value![0].ratingDetails?.poorCount.toString() ?? "0", color: const Color(0xFF000000), fontWeight: FontWeight.w500, fontSize: 12, family: 'Graphik'),
                                                  ],
                                                ),
                                              ],
                                            ),
