...
import '../../../model/trade_product_model/Insentive.dart';
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(
                          ...
                          children: [
                            ...
                            WidgetUtils.appTextWidget(
                                context: context, title: redeemdataList[index].incentiveName ?? "", color: const Color(0xff3F3F3F), fontWeight: FontWeight.w500, fontSize: 14, family: 'Graphik'),
                            WidgetUtils.appTextWidget(context: context, title: date ?? "", color: const Color(0xff3F3F3F), fontWeight: FontWeight.w400, fontSize: 12, family: 'Graphik'),
                          ],
                        ),
                        const SizedBox(height: 8),
