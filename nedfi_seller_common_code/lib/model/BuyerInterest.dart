import 'package:nedfi_seller_common_code/model/trade_product_info.dart';
...
class ProdInterestData {
  ...
  ProdInterestData(
      {this.id,
        ...
        this.status_title,
        this.priceUnitTitle,this.prod_details_title});
  ...
  Map<String, dynamic> toJson() {
    ...
    data['prod_details_title'] = this.prod_details_title;
...
class BuyerInterestList {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['interest_shown_on'] = this.interestShownOn;
...
class RatingDetails {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['happy_count'] = this.happyCount;
    data['average_count'] = this.averageCount;
    data['poor_count'] = this.poorCount;
    return data;
  }
}