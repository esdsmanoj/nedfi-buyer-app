...
class Data {
  ...
  Data({this.productCategory, this.season, this.productUnit, this.productPayment, this.tradeStatusList, this.userType, this.businessType, this.businessScheme,this.fpcBusinessScheme});
