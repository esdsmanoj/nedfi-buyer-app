class MarketResponse {
  ...
  MarketResponse.fromJson(Map<String, dynamic> json) {
    ...
    if(json['more_details']!=null) {
      more_details = List.from(json['more_details'])
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['more_details'] = more_details?.map((e) => e.toJson()).toList();
...
class MarketData {
  ...
  MarketData(
      {this.id, this.distance, this.apmcMarket, this.latitude, this.longitude});
