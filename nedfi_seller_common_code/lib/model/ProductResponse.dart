class ProductResponse {
  ...
  ProductResponse.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? List.from(json['data']).map((e) => ProductData.fromJson(e)).toList() : [];
    msg = json['msg'];
    error = json['error'];
    status = json['status'];
  }
...
class ProductsList {
  ...
  late final dynamic deletedById;
  late final dynamic deletedOn;
  String? type;
  late final dynamic productOffered;
  late final String? registerApi;
  late final String? packageNote;
  late final String? programmingLang;
  late final dynamic otherProgrammingLang;
  late final String? framework;
  late final dynamic otherFramework;
  late final String userManual;
  late final String? caseStudy;
  late final dynamic defaultCredentialData;
  late final String? clientLoginUrl;
  late final String status;
  late final dynamic productScore;
