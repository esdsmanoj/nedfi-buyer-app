class HomeCatagoryResponse {
  HomeCatagoryResponse({
  ...
  late final List<HomeCatagoryData> data;
  late final List<BlogType> blogType;
  late final ConfigUrl configUrl;
  late final HomeMessage homeMessage;
  late final String message;

  HomeCatagoryResponse.fromJson(Map<String, dynamic> json){
    status = json['status'];
    data = List.from(json['data']).map((e)=>HomeCatagoryData.fromJson(e)).toList();
    blogType = List.from(json['blog_type']).map((e)=>BlogType.fromJson(e)).toList();
