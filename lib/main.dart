...
import 'package:buyer_common_code/components/utils/NotificationUtils.dart';
    ...
    return ThemeBuilder(
      builder: (context, _brightness) {
        return GetMaterialApp(
            ...
            home: const SplashScreen(route: 'nedfi', splashImagePath: "assets/images/nedfi.png", appDetailsName: 'nerace', domainName: 'nerace'),
